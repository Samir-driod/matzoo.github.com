...
var los = Math.round(Math.random() * 2); 
    ...
    // wyswietl los
    $('#zadanie').html('<p class="wyraz1 s60">'+ liczbap[los] + '&nbsp;'+ jednostka[los] + ' = <input name="odp" type="text" class="input" id="odp" size="3" maxlength="5" autocomplete="off" />&nbsp;kg\n\
...
function createStatement() {
    ...
    wyn = ($('#wynik').val());
    var statement = ' ' + liczbap + '&nbsp;' + jednostka + ' = ' + wyn + '&nbsp;kg<span class="s15 pull-right black" style="font-family: ">wpisano: ' + $('#odp').val() + '</span>';
    return statement;
}
