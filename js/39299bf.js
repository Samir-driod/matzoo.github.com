...
$('#my-memorygame').css('margin-left','8%');
    
var size = $(window).width();       
    
if (size>1200) {
    $('#my-memorygame').quizyMemoryGame({itemWidth: 120, itemHeight: 120, itemsMargin:10, colCount:5, animType:'flip' , flipAnim:'tb', animSpeed:250, resultIcons:false});
} else if (size>970) {
    $('#my-memorygame').quizyMemoryGame({itemWidth: 110, itemHeight: 110, itemsMargin:10, colCount:5, animType:'flip' , flipAnim:'tb', animSpeed:250, resultIcons:false});
} else if (size>780) {
    $('#my-memorygame').quizyMemoryGame({itemWidth: 120, itemHeight: 120, itemsMargin:10, colCount:5, animType:'flip' , flipAnim:'tb', animSpeed:250, resultIcons:false});
} else if (size>680) {
    $('#my-memorygame').quizyMemoryGame({itemWidth: 110, itemHeight: 110, itemsMargin:10, colCount:5, animType:'flip' , flipAnim:'tb', animSpeed:250, resultIcons:false});
} else if (size>540) {
    $('#my-memorygame').quizyMemoryGame({itemWidth: 96, itemHeight: 96, itemsMargin:5, colCount:5, animType:'flip' , flipAnim:'tb', animSpeed:250, resultIcons:false});
} else if (size>400) {
    $('#my-memorygame').quizyMemoryGame({itemWidth: 90, itemHeight: 90, itemsMargin:5, colCount:4, animType:'flip' , flipAnim:'tb', animSpeed:250, resultIcons:false});
} else if (size>315) {
    $('#my-memorygame').css('margin','3%');
    $('#my-memorygame').quizyMemoryGame({itemWidth: 64, itemHeight: 64, itemsMargin:5, colCount:4, animType:'flip' , flipAnim:'tb', animSpeed:250, resultIcons:true});
} else {
    $('#my-memorygame').quizyMemoryGame({itemWidth: 68, itemHeight: 68, itemsMargin:5, colCount:3, animType:'flip' , flipAnim:'tb', animSpeed:250, resultIcons:true});
}     
