...
function los() {
  ...
  if (example==8) {
    var tresc = '<b>'+g+'x+'+h+'y<sup>2</sup></b> &nbsp;<span class="s30 dblue">dla &nbsp; </span> <b>x='+zmienna+'</b> <span class="s30 white">i</span> <b>y='+zmienna2+'</b>';
    var wynik = (g*zmienna)+(h*zmienna2*zmienna2);
    
  }
  else if (example==7){
    var tresc = '<b>x<sup>2</sup>+'+h+'y</b> &nbsp;<span class="s30 dblue">dla &nbsp; </span> <b>x='+zmienna+'</b> <span class="s30 white">i</span> <b>y='+zmienna2+'</b>';
    var wynik = (zmienna*zmienna)+(h*zmienna2);
  
  }
  
  else if (example==6){
    var tresc = '<b>x<sup>2</sup>-y</b> &nbsp;<span class="s30 dblue">dla &nbsp; </span> <b>x='+zmienna+'</b> <span class="s30 white">i</span> <b>y='+zmienna2+'</b>';
    var wynik = (zmienna*zmienna)-zmienna2;
  }
  
  else  if (example==0) {
  var tresc = '<b>'+g+'x+'+h+'y-'+e+'</b> &nbsp;<span class="s30 dblue">dla &nbsp; </span> <b>x='+zmienna+'</b> <span class="s30 white">i</span> <b>y='+zmienna2+'</b>';
  ...
  var tresc = '<b>'+g+'x-'+h+'y</b> &nbsp;<span class="s30 dblue">dla &nbsp; </span> <b>x='+zmienna+'</b> <span class="s30 white">i</span> <b>y='+zmienna2+'</b>';
