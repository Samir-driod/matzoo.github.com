...
$(document).ready(function() {
    ...
    $('#zadanie').addClass('polecenie');  
    $('#zadanie').css('font-size','25pt');  
    los();
    keyboardEnter(0);
...
function los() {
  ...
  if (example==1) {
    ...
    polecenie = '<p class="text-center">Zaokrąglij do części dziesiętnych.</p>';
  ...
  // wyswietl los
  $('#zadanie').html(polecenie+'<p class="wyrazm text-center s45"><input name="odp3" type="tel" style="opacity:0;float:left" size="1" maxlength="2" autocomplete="off" />'+px + ' = <input name="odp" type="tel" class="s50" id="odp" size="5" maxlength="6" autocomplete="off" /><input name="odp2" type="tel" style="opacity:0;float:right" id="odp2" size="1" maxlength="2" /></p>');
  $('#wynik').val(y);
  $('#odp').focus();
