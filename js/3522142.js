...
function los(last) {
    ...
    pytanie = '';
    for (i = 0; i < pytania[x].length-2; i++) {
        $('#zadanie').append('<div class="btn btn-default padding8 margin2"><img class="img-responsive" src="img/wzory/'+pytania[x][i]+'l.png" style="max-height:46px;margin:1px;float:left"></div>');
    }
    ...
    $('#zadanie').append('<div class="row center-block" style="overflow:hidden">');
    for (i = 0; i < pytania[x].length; i++) {
        $('#zadanie').append('<div class="btn btn-default padding8 margin2" id="w'+i+'">\n\
<img class="img-responsive" src="img/wzory/1l.png" id="w'+i+'1" style="max-height:46px;margin:1px;float:left;opacity:0;">\n\
<img class="img-responsive" src="img/wzory/2l.png" id="w'+i+'2" style="max-height:46px;margin:1px;float:left;opacity:0;position: absolute;">\n\
<img class="img-responsive" src="img/wzory/3l.png" id="w'+i+'3" style="max-height:46px;margin:1px;float:left;opacity:0;position: absolute;">\n\
</div>');
    }
