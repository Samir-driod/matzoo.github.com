...
['9√2', '9√2', '18'],
    ...
    var ex = Math.round(Math.random()*3)+1;
  ...
  <div class="card"><div class="trojprost45"><div class="troj45-a">'+tab[example][0]+'</div><div class="troj45-b">'+tab[example][1]+'</div><div class="troj45-c">'+tab[example][2]+'</div></div>\n\
</div><div class="card"><a class="znak btn btn-lsuccess btn-matzoo gradient s21 text-black margin0 pull-right" style="padding:8px" onclick="radic(\'&radic;\')"><img alt="&radic;" src="img/zn_sqrtsm.png"></a>\n\
<br><br class="hidden-xs">&nbsp;'+litera+' = <input type="text" id="odp" size=2 name="odp" autocomplete="off" /><input name="odp3" type="text" style="opacity:0;float:right;height:1px" id="odp3" size="1" autocomplete="off" maxlength="2" /><br></div>\n\
  </div>\n\
...
<div class="tekstowe-solve tekstowe">\n\
    <p class="main-solve">Połowa kwadratu - zależności</p><p class=text-center>\n\
<img src="imgtask/troj_prost45wzory.png" alt="rysunek" style="max-width:75%"/>\n\
