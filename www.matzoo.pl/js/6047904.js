...
for (i=0;i<x;i++) {
    ...
    $('#zadanie').html(tresc);
        ...
        $('#zadanie').append('<p>'+ginner + '   = <input name="odp" type="tel" class="wyraz1" id="odp" size="1" maxlength="3" autocomplete="off" /> \n\
...
function createStatement() {
    ...
    var statement = ' ' + ginner + ' = ' + wyn  + ' <span class="s15 pull-right black" style="font-family: ">wpisano: ' + $('#odp').val() + '</span>';
    return statement;
}
