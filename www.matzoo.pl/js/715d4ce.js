...
function los() {
    ...
    var statement = wynik + ' cm w skali '+scale[example]+' to '+x+' cm.';
    // wyswietl los
    $('#zadanie').html('<input name="odp" type="tel" class="wyrazm" id="odp" size="3" maxlength="6" autocomplete="off" /> cm ' +
        'w skali <span class="dblue">' + scale[example] + '</span> to ' + x + ' cm.' +
