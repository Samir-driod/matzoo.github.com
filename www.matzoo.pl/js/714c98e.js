...
function los() {
    ...
    var statement = x + ' cm w skali '+scale[example]+' to '+wynik+' cm.';
    // wyswietl los
    $('#zadanie').html(x + ' cm w skali <span class="dblue">' + scale[example] + '</span> to \
    <input name="odp" type="tel" class="wyrazm" id="odp" size="3" maxlength="6" autocomplete="off" /> cm.\n\
