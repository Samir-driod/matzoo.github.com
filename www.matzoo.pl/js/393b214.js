...
$('#my-memorygame').css('margin-left','10%');
    
var size = $(window).width();    

if (size>1200) {
    $('#my-memorygame').quizyMemoryGame({itemWidth: 100, itemHeight: 100, itemsMargin:8, colCount:6, animType:'flip' , flipAnim:'tb', animSpeed:250, resultIcons:false});
} else if (size>970) {
    $('#my-memorygame').quizyMemoryGame({itemWidth: 90, itemHeight: 90, itemsMargin:4, colCount:6, animType:'flip' , flipAnim:'tb', animSpeed:250, resultIcons:false});
} else if (size>780) {
    $('#my-memorygame').quizyMemoryGame({itemWidth: 100, itemHeight: 100, itemsMargin:8, colCount:6, animType:'flip' , flipAnim:'tb', animSpeed:250, resultIcons:false});
} else if (size>680) {
    $('#my-memorygame').quizyMemoryGame({itemWidth: 90, itemHeight: 90, itemsMargin:4, colCount:6, animType:'flip' , flipAnim:'tb', animSpeed:250, resultIcons:false});
} else if (size>540) {
    $('#my-memorygame').quizyMemoryGame({itemWidth: 90, itemHeight: 90, itemsMargin:4, colCount:5, animType:'flip' , flipAnim:'tb', animSpeed:250, resultIcons:false});
} else if (size>400) {
    $('#my-memorygame').quizyMemoryGame({itemWidth: 64, itemHeight: 64, itemsMargin:4, colCount:5, animType:'flip' , flipAnim:'tb', animSpeed:250, resultIcons:false});
} else if (size>315) {
    ...
    $('#my-memorygame').quizyMemoryGame({itemWidth: 54, itemHeight: 54, itemsMargin:4, colCount:4, animType:'flip' , flipAnim:'tb', animSpeed:250, resultIcons:true});
}    
