...
function los() {
    ...
    var zdanie = [ '<p>Następny miesiąc po '+miesiac[x]+' to:</p>', '<p>Miesiąc przed '+miesiac[x]+' to:</p>','<p>2 miesiące po '+miesiac[x]+' to:</p>', '<p>2 miesiące przed '+miesiac[x]+' to:</p>', '<p>'+miesiac[x] + ' miesiąc w roku. </p>', '<p>'+miesiac[x] + ' miesiąc w roku. </p>'];
